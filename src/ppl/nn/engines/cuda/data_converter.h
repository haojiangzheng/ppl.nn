...
public:
    ...
    ppl::common::RetCode ConvertToHost(void* dst, const ppl::common::TensorShape& dst_desc, const CudaTensorQuant& dst_quant,
                                       const BufferDesc& src, const ppl::common::TensorShape& src_desc,
                                       const CudaTensorQuant& src_quant) const;

    ppl::common::RetCode ConvertFromHost(BufferDesc* dst, const ppl::common::TensorShape& dst_desc, const CudaTensorQuant& dst_quant,
                                         const void* src, const ppl::common::TensorShape& src_desc,
                                         const CudaTensorQuant& src_quant) const;

    ppl::common::RetCode Convert(BufferDesc* dst, const ppl::common::TensorShape& dst_desc, const CudaTensorQuant& dst_quant,
                                 const BufferDesc& src, const ppl::common::TensorShape& src_desc,
                                 const CudaTensorQuant& src_quant) const;
