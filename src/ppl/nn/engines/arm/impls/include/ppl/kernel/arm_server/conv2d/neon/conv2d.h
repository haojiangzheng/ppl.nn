...
public:
    ...
    static conv2d_offline_manager *fast_gen_algo(const ppl::common::TensorShape &shape, const ppl::nn::arm::EngineOptions &options, const ppl::common::isa_t isa_flags, const conv2d_param &param, ppl::common::Allocator *allocator);
    // run all possible algo & block size, select the best one and return the final algo manager.
    static conv2d_offline_manager *gen_fast_algo(const ppl::common::TensorShape &shape, const ppl::nn::arm::EngineOptions &options, const ppl::common::isa_t isa_flags, const conv2d_param &param, ppl::common::Allocator *allocator);
};
