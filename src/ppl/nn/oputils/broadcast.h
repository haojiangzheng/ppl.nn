...
public:
    ...
    void SetInputTensorShape0(const ppl::common::TensorShape& input_tensor_shape0) {
        input_tensor_shape0_ = input_tensor_shape0;
    }
    void SetInputTensorShape1(const ppl::common::TensorShape& input_tensor_shape1) {
        input_tensor_shape1_ = input_tensor_shape1;
    }
    const ppl::common::TensorShape& InputTensorShape0() const {
        return input_tensor_shape0_;
    }
    const ppl::common::TensorShape& InputTensorShape1() const {
        return input_tensor_shape1_;
    }

    virtual void CalcBroadCast(void) = 0;

    void SetInputTensorShapes(const ppl::common::TensorShape& input_tensor_shape0, const ppl::common::TensorShape& input_tensor_shape1) {
        input_tensor_shape0_ = input_tensor_shape0;
        input_tensor_shape1_ = input_tensor_shape1;
    ...
    const ppl::common::TensorShape& OutputTensorShape(void) const {
        return output_tensor_shape_;
    }

protected:
    bool can_broadcast_ = false;
    ppl::common::TensorShape input_tensor_shape0_;
    ppl::common::TensorShape input_tensor_shape1_;
    ppl::common::TensorShape output_tensor_shape_;
};
...
public:
    ...
    ppl::common::TensorShape InputTensorShape(uint32_t idx) const {
        if (idx < input_tensor_shapes_.size()) {
            return input_tensor_shapes_[idx];
        }
        return ppl::common::TensorShape();
    }

    void SetInputTensorShape(uint32_t idx, const ppl::common::TensorShape& shape) {
        if (idx < input_tensor_shapes_.size()) {
            input_tensor_shapes_[idx] = shape;
        }
    }

    void PushBackInputTensorShape(const ppl::common::TensorShape& shape) {
        input_tensor_shapes_.push_back(shape);
    }

    void SetInputTensorShapes(const std::vector<ppl::common::TensorShape>& shapes) {
...
private:
    bool can_broadcast_ = false;
    std::vector<ppl::common::TensorShape> input_tensor_shapes_;
    ppl::common::TensorShape output_tensor_shape_;
};
